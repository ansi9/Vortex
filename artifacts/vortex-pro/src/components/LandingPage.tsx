...
export function LandingPage() {
  ...
  return (
    <div 
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-gradient-to-br from-[#ecfccb] to-[#dcfce7] transition-transform duration-700 ease-in-out ${isUnlocked ? '-translate-y-full' : 'translate-y-0'}`}
    >
